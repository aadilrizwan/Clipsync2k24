...
const SettingsPage = () => {
  ...
  return (
    <div>
      ...
      <h2 className="text-2xl font-bold mt-4 text-white dark:text-blue-700">
        Video Sharing Preferences
      </h2>
      <p className="text-muted-foreground">
        Activating this feature will send you a notification the first time
        someone watches your video. It can be a valuable tool for client
        outreach
      </p>
